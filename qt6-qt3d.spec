...
%else
Source:		https://download.qt.io/%{?beta:development}%{!?beta:official}_releases/qt/%(echo %{version}|cut -d. -f1-2)/%{version}%{?beta:-%{beta}}/submodules/qt3d-everywhere-src-%{version}%{?beta:-%{beta}}.tar.xz
%endif
...
%qt6libs 3DCore 3DAnimation 3DExtras 3DInput 3DLogic 3DQuickAnimation 3DQuickExtras 3DQuickInput 3DQuick 3DQuickLogic 3DQuickRender 3DQuickScene2D 3DQuickScene3D 3DRender
